      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-4">
            <Button
              size="lg"
              className="bg-primary text-primary-foreground rounded-xl px-6 h-14 flex items-center gap-3 min-w-[150px]"
              asChild
            >
            ...
            <Button
              size="lg"
              variant="outline"
              className="rounded-xl px-6 h-14 border-2 flex items-center gap-3 min-w-[150px]"
              asChild
            >
