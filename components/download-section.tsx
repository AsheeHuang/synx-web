          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <Button
                ...
                variant="outline"
                disabled
                className="w-full rounded-2xl h-16 sm:h-20 text-base sm:text-lg border-2 bg-transparent opacity-60 cursor-not-allowed"
              >
                <svg className="w-6 h-6 sm:w-8 sm:h-8 mr-3" viewBox="0 0 24 24" fill="currentColor">
              ...
              <p className="text-sm text-muted-foreground text-center pt-4">{t.download.comingSoon}</p>
            </div>
          </div>
        </div>
      </div>
